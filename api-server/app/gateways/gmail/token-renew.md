...
4. Paste it into your web browser (Chrome, Edge, Firefox, etc.)
5. Sign in to Google with your account (e.g. something@gmail.com)
6. Click "Allow" when Google asks for permissions.
...
7. Look at the URL in your browser's address bar after you authorize
