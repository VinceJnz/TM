...
func (h *Handler) GetAll(w http.ResponseWriter, r *http.Request) {
	dbStandardTemplate.GetAll(w, r, debugTag, h.appConf.Db, &[]models.UserGroup{}, qryGetAll)
}

// Get: retrieves and returns a single record identified by id
func (h *Handler) Get(w http.ResponseWriter, r *http.Request) {
	id := dbStandardTemplate.GetID(w, r)
	dbStandardTemplate.Get(w, r, debugTag, h.appConf.Db, &[]models.UserGroup{}, qryGet, id)
}
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	dbStandardTemplate.Create(w, r, debugTag, h.appConf.Db, &record.ID, qryCreate, record.UserID, record.GroupID)
}
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	dbStandardTemplate.Update(w, r, debugTag, h.appConf.Db, &record, qryUpdate, record.UserID, record.GroupID, id)
}
