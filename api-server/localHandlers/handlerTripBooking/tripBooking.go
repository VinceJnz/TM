...
const debugTag = "handlerTripBooking."
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	err := h.db.QueryRow(`
		INSERT INTO at_trip_booking (owner_id, booking_id, person_id, notes) 
...
func (h *Handler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	_, err = h.db.Exec("DELETE FROM at_trip_booking WHERE id = $1", id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
