...
func (h *Handler) GetAll(w http.ResponseWriter, r *http.Request) {
	...
	err := h.db.Select(&records, `SELECT id, trip_id, user_type_id, season_id, amount, created, modified
                                  FROM at_trip_costs`)
...
func (h *Handler) Get(w http.ResponseWriter, r *http.Request) {
	...
	err = h.db.Get(&record, `SELECT id, trip_id, user_type_id, season_id, amount, created, modified
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	err = tx.QueryRow(`
        INSERT INTO at_trip_costs (trip_id, user_type_id, season_id, amount) 
        VALUES ($1, $2, $3, $4) RETURNING id`,
		record.TripID, record.UserTypeID, record.SeasonID, record.Amount,
	).Scan(&record.ID)
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	_, err = h.db.Exec(`
        ...
        SET trip_id = $1, user_type_id = $2, season_id = $3, amount = $4
        WHERE id = $5`,
		record.TripID, record.UserTypeID, record.SeasonID, record.Amount, record.ID,
	)
	if err != nil {
