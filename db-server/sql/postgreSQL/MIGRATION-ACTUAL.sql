-- ============================================================================
-- Database Referential Integrity Migration Script (For Actual Database)
-- ============================================================================
-- Purpose: Fix foreign key constraints to prevent orphaned data
-- Date: 2026-03-21
-- Current State: Only 3 foreign keys exist (all NO ACTION)
-- ============================================================================
...
-- Booking vouchers: CASCADE (vouchers belong to booking)
ALTER TABLE at_booking_vouchers 
    ADD CONSTRAINT at_booking_vouchers_booking_id_fkey 
    FOREIGN KEY (booking_id) REFERENCES at_bookings(id) 
    ON DELETE CASCADE ON UPDATE CASCADE;
