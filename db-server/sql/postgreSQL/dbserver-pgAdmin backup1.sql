...
--
-- TOC entry 251 (class 1255 OID 16710)
...
--
-- TOC entry 249 (class 1259 OID 16894)
-- Name: at_booking_vouchers; Type: TABLE; Schema: public; Owner: myuser
--

CREATE TABLE public.at_booking_vouchers (
    id integer NOT NULL,
    ...
    created timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    modified timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT at_booking_vouchers_discount_ck CHECK (((discount_percent IS NULL) OR ((discount_percent >= (0)::numeric) AND (discount_percent <= (100)::numeric)))),
    CONSTRAINT at_booking_vouchers_fixed_cost_ck CHECK (((fixed_cost IS NULL) OR (fixed_cost >= (0)::numeric))),
    CONSTRAINT at_booking_vouchers_mode_ck CHECK (((discount_percent IS NULL) <> (fixed_cost IS NULL)))
);


ALTER TABLE public.at_booking_vouchers OWNER TO myuser;

--
-- TOC entry 248 (class 1259 OID 16892)
-- Name: at_booking_vouchers_id_seq; Type: SEQUENCE; Schema: public; Owner: myuser
--

ALTER TABLE public.at_booking_vouchers ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.at_booking_vouchers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: et_access_scope_id_seq; Type: SEQUENCE; Schema: public; Owner: myuser
--

CREATE SEQUENCE public.et_access_scope_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 2147483647
...
ALTER SEQUENCE public.et_access_scope_id_seq OWNER TO myuser;

--
-- TOC entry 217 (class 1259 OID 16519)
-- Name: et_access_scope; Type: TABLE; Schema: public; Owner: myuser
--

CREATE TABLE public.et_access_scope (
    id integer DEFAULT nextval('public.et_access_scope_id_seq'::regclass) NOT NULL,
    name character varying(45),
    description character varying(45),
    created timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    modified timestamp without time zone DEFAULT CURRENT_TIMESTAMP
...
ALTER TABLE public.et_access_scope OWNER TO myuser;
...
INSERT INTO public.at_booking_vouchers VALUES (2, 'SAVE15', 15.00, NULL, NULL, true, '2026-03-05 09:04:01.101458', '2026-03-05 09:04:01.101458');
INSERT INTO public.at_booking_vouchers VALUES (3, 'FLAT50', NULL, 50.00, NULL, true, '2026-03-05 09:04:01.101458', '2026-03-05 09:04:01.101458');
INSERT INTO public.at_booking_vouchers VALUES (1, 'WELCOME10', 10.00, NULL, '2026-03-12', true, '2026-03-05 09:04:01.101458', '2026-03-05 09:08:22.32415');
...
INSERT INTO public.et_access_scope VALUES (2, 'own', NULL, '2024-11-24 23:15:13.207337', '2026-03-05 10:30:04.85804');
INSERT INTO public.et_access_scope VALUES (1, 'any', NULL, '2024-11-24 23:14:57.462385', '2026-03-05 10:30:04.85804');
...
INSERT INTO public.et_booking_status VALUES (4, 'Partially paid', '2026-03-06 06:01:35.088127', '2026-03-06 06:01:41.372249');
...
INSERT INTO public.et_resource VALUES (21, 'bookingVouchers', 'API resource', '2026-03-06 00:42:22.741919', '2026-03-06 00:42:22.741919');
INSERT INTO public.et_resource VALUES (22, 'seasons', 'API resource', '2026-03-06 00:42:22.741919', '2026-03-06 00:42:22.741919');
INSERT INTO public.et_resource VALUES (23, 'userPayments', 'API resource', '2026-03-06 00:42:22.741919', '2026-03-06 00:42:22.741919');
INSERT INTO public.et_resource VALUES (24, 'groupBooking', 'API resource', '2026-03-06 00:42:22.741919', '2026-03-06 00:42:22.741919');
INSERT INTO public.et_resource VALUES (25, 'tripType', 'API resource', '2026-03-06 00:42:22.741919', '2026-03-06 00:42:22.741919');
INSERT INTO public.et_resource VALUES (26, 'tripCosts', 'API resource', '2026-03-06 00:42:22.741919', '2026-03-06 00:42:22.741919');
INSERT INTO public.et_resource VALUES (27, 'tripCostGroups', 'API resource', '2026-03-06 00:42:22.741919', '2026-03-06 00:42:22.741919');
INSERT INTO public.et_resource VALUES (28, 'securityResource', 'API resource', '2026-03-06 00:42:22.741919', '2026-03-06 00:42:22.741919');
INSERT INTO public.et_resource VALUES (29, 'securityGroup', 'API resource', '2026-03-06 00:42:22.741919', '2026-03-06 00:42:22.741919');
INSERT INTO public.et_resource VALUES (30, 'securityGroupResource', 'API resource', '2026-03-06 00:42:22.741919', '2026-03-06 00:42:22.741919');
INSERT INTO public.et_resource VALUES (31, 'securityUserGroup', 'API resource', '2026-03-06 00:42:22.741919', '2026-03-06 00:42:22.741919');
INSERT INTO public.et_resource VALUES (32, 'securityAccessLevel', 'API resource', '2026-03-06 00:42:22.741919', '2026-03-06 00:42:22.741919');
INSERT INTO public.et_resource VALUES (33, 'securityAccessScope', 'API resource', '2026-03-06 00:42:22.741919', '2026-03-06 00:42:22.741919');
INSERT INTO public.et_resource VALUES (34, 'securityAccessType', 'API resource', '2026-03-06 00:42:22.741919', '2026-03-06 00:42:22.741919');
INSERT INTO public.et_resource VALUES (3, 'bookings', 'bookings', '2024-11-24 23:20:48.161546', '2026-03-06 00:46:38.483437');
INSERT INTO public.et_resource VALUES (2, 'trips', 'trips', '2024-11-24 23:20:40.311542', '2026-03-06 00:46:38.483437');
INSERT INTO public.et_resource VALUES (1, 'users', 'users', '2024-11-24 23:20:21.603342', '2026-03-06 00:46:38.483437');
...
INSERT INTO public.st_group VALUES (1, 'Sys Admin', 'System admin', '2024-11-24 23:31:26.62785', '2026-02-27 09:48:24.645486');
INSERT INTO public.st_group VALUES (3, 'App Admin', 'Application admin', '2024-12-05 23:46:11.129967', '2026-02-27 09:48:24.645486');
INSERT INTO public.st_group VALUES (2, 'User', 'app users', '2024-12-05 06:57:30.344557', '2026-02-27 09:48:24.645486');
INSERT INTO public.st_group VALUES (5, 'Trusted User', 'Trusted User', '2026-03-05 10:35:59.877022', '2026-03-05 10:35:59.877022');
...
INSERT INTO public.st_group_resource VALUES (42, 1, 1, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (43, 1, 2, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (44, 1, 3, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (45, 1, 8, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (46, 1, 9, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (47, 1, 10, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (48, 1, 11, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (49, 1, 13, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (50, 1, 14, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (51, 1, 16, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (52, 1, 17, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (53, 1, 15, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (54, 1, 5, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (55, 1, 19, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (56, 1, 20, 1, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (57, 1, 3, 2, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (58, 1, 8, 2, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (59, 1, 9, 2, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (60, 1, 10, 2, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (61, 1, 11, 2, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (62, 1, 13, 2, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (63, 1, 14, 2, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (64, 1, 16, 2, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (65, 1, 17, 2, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (66, 1, 15, 2, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (67, 1, 5, 2, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (68, 1, 19, 2, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (69, 1, 20, 2, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (70, 1, 3, 3, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (71, 1, 8, 3, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (72, 1, 9, 3, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (73, 1, 10, 3, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (74, 1, 11, 3, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (75, 1, 13, 3, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (76, 1, 14, 3, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (77, 1, 16, 3, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (78, 1, 17, 3, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (79, 1, 15, 3, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (80, 1, 5, 3, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (81, 1, 19, 3, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (82, 1, 20, 3, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (83, 1, 2, 4, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (84, 1, 3, 4, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (85, 1, 8, 4, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (86, 1, 9, 4, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (87, 1, 10, 4, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (88, 1, 11, 4, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (89, 1, 13, 4, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (90, 1, 14, 4, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (91, 1, 16, 4, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (92, 1, 17, 4, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (93, 1, 15, 4, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (94, 1, 5, 4, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (95, 1, 19, 4, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (96, 1, 20, 4, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (97, 1, 2, 5, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (98, 1, 3, 5, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (99, 1, 8, 5, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (100, 1, 9, 5, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (101, 1, 10, 5, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (102, 1, 11, 5, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (103, 1, 13, 5, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (104, 1, 14, 5, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (105, 1, 16, 5, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (106, 1, 17, 5, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (107, 1, 15, 5, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (108, 1, 5, 5, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (109, 1, 19, 5, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (110, 1, 20, 5, 1, '2026-03-06 00:31:03.940149', '2026-03-06 00:31:03.940149');
INSERT INTO public.st_group_resource VALUES (111, 1, 21, 1, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (112, 1, 22, 1, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (113, 1, 23, 1, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (114, 1, 24, 1, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (115, 1, 25, 1, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (116, 1, 26, 1, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (117, 1, 27, 1, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (118, 1, 28, 1, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (119, 1, 29, 1, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (120, 1, 30, 1, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (121, 1, 31, 1, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (122, 1, 32, 1, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (123, 1, 33, 1, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (124, 1, 34, 1, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (125, 1, 21, 2, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (126, 1, 22, 2, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (127, 1, 23, 2, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (128, 1, 24, 2, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (129, 1, 25, 2, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (130, 1, 26, 2, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (131, 1, 27, 2, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (132, 1, 28, 2, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (133, 1, 29, 2, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (134, 1, 30, 2, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (135, 1, 31, 2, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (136, 1, 32, 2, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (137, 1, 33, 2, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (138, 1, 34, 2, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (139, 1, 21, 3, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (140, 1, 22, 3, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (141, 1, 23, 3, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (142, 1, 24, 3, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (143, 1, 25, 3, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (144, 1, 26, 3, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (145, 1, 27, 3, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (146, 1, 28, 3, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (147, 1, 29, 3, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (148, 1, 30, 3, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (149, 1, 31, 3, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (150, 1, 32, 3, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (151, 1, 33, 3, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (152, 1, 34, 3, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (153, 1, 21, 4, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (154, 1, 22, 4, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (155, 1, 23, 4, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (156, 1, 24, 4, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (157, 1, 25, 4, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (158, 1, 26, 4, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (159, 1, 27, 4, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (160, 1, 28, 4, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (161, 1, 29, 4, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (162, 1, 30, 4, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (163, 1, 31, 4, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (164, 1, 32, 4, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (165, 1, 33, 4, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (166, 1, 34, 4, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (167, 1, 21, 5, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (168, 1, 22, 5, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (169, 1, 23, 5, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (170, 1, 24, 5, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (171, 1, 25, 5, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (172, 1, 26, 5, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (173, 1, 27, 5, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (174, 1, 28, 5, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (175, 1, 29, 5, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (176, 1, 30, 5, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (177, 1, 31, 5, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (178, 1, 32, 5, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (179, 1, 33, 5, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
INSERT INTO public.st_group_resource VALUES (180, 1, 34, 5, 1, '2026-03-06 00:44:16.863385', '2026-03-06 00:44:16.863385');
...
INSERT INTO public.st_users VALUES (3, 'Dylan Jennings1', 'Dylan', 'dylan@dt.net.nz', 1, '2024-10-04 09:09:11.226469', '2026-03-03 01:13:49.21956', NULL, 4, '93 Farnham Street, Mornington', '12347', NULL, 1, true, NULL, NULL);
...
SELECT pg_catalog.setval('public.at_booking_users_id_seq', 31, true);
...
SELECT pg_catalog.setval('public.at_booking_vouchers_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.at_bookings_id_seq', 38, true);
...
SELECT pg_catalog.setval('public.et_access_scope_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.et_booking_status_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.et_resource_id_seq', 34, true);
...
SELECT pg_catalog.setval('public.st_group_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.st_group_resource_id_seq', 180, true);
...
--
-- TOC entry 3124 (class 2606 OID 16432)
...
--
-- TOC entry 3174 (class 2606 OID 16906)
-- Name: at_booking_vouchers at_booking_vouchers_code_key; Type: CONSTRAINT; Schema: public; Owner: myuser
--

ALTER TABLE ONLY public.at_booking_vouchers
    ADD CONSTRAINT at_booking_vouchers_code_key UNIQUE (code);


--
-- TOC entry 3176 (class 2606 OID 16904)
-- Name: at_booking_vouchers at_booking_vouchers_pkey; Type: CONSTRAINT; Schema: public; Owner: myuser
--

ALTER TABLE ONLY public.at_booking_vouchers
    ADD CONSTRAINT at_booking_vouchers_pkey PRIMARY KEY (id);


--
-- TOC entry 3126 (class 2606 OID 16448)
...
--
-- TOC entry 3128 (class 2606 OID 16459)
...
--
-- TOC entry 3130 (class 2606 OID 16469)
...
--
-- TOC entry 3132 (class 2606 OID 16479)
...
--
-- TOC entry 3134 (class 2606 OID 16496)
...
--
-- TOC entry 3136 (class 2606 OID 16506)
...
--
-- TOC entry 3138 (class 2606 OID 16516)
...
--
-- TOC entry 3140 (class 2606 OID 16526)
-- Name: et_access_scope et_access_type_pkey; Type: CONSTRAINT; Schema: public; Owner: myuser
--

ALTER TABLE ONLY public.et_access_scope
    ADD CONSTRAINT et_access_type_pkey PRIMARY KEY (id);


--
-- TOC entry 3142 (class 2606 OID 16536)
...
--
-- TOC entry 3144 (class 2606 OID 16546)
...
--
-- TOC entry 3146 (class 2606 OID 16556)
...
--
-- TOC entry 3148 (class 2606 OID 16566)
...
--
-- TOC entry 3150 (class 2606 OID 16576)
...
--
-- TOC entry 3152 (class 2606 OID 16586)
...
--
-- TOC entry 3154 (class 2606 OID 16596)
...
--
-- TOC entry 3156 (class 2606 OID 16609)
...
--
-- TOC entry 3158 (class 2606 OID 16619)
...
--
-- TOC entry 3160 (class 2606 OID 16630)
...
--
-- TOC entry 3162 (class 2606 OID 16641)
...
--
-- TOC entry 3164 (class 2606 OID 16652)
...
--
-- TOC entry 3166 (class 2606 OID 16662)
...
--
-- TOC entry 3168 (class 2606 OID 16679)
...
--
-- TOC entry 3172 (class 2606 OID 16681)
...
CREATE TRIGGER set_modified_timestamp_et_access_type BEFORE UPDATE ON public.et_access_scope FOR EACH ROW EXECUTE FUNCTION public.update_modified_column();
...
--
-- TOC entry 3177 (class 2606 OID 16978)
-- Name: at_booking_people booking_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: myuser
--

ALTER TABLE ONLY public.at_booking_people
    ADD CONSTRAINT booking_id_fkey FOREIGN KEY (booking_id) REFERENCES public.at_bookings(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.at_bookings
    ADD CONSTRAINT bookings_status_id_fkey FOREIGN KEY (booking_status_id) REFERENCES public.et_booking_status(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- TOC entry 3178 (class 2606 OID 16983)
-- Name: at_booking_people user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: myuser
--

ALTER TABLE ONLY public.at_booking_people
    ADD CONSTRAINT user_id_fkey FOREIGN KEY (person_id) REFERENCES public.st_users(id) ON UPDATE CASCADE ON DELETE RESTRICT;
